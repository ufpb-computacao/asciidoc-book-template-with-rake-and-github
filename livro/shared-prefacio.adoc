...
_livro/code/{cap}_.  O diretório _{cap}_ indica o capítulo
...
{gitrepo}/tree/{edition}/livro/code
...
fontes estão organizados por capítulos no diretório `livro/code`.
...
em: https://github.com/edusantana/guia-geral-ead-computacao-ufpb/blob/master/livro/livros-contribuicao.adoc.
